...
<div style='text-align:center; margin-bottom:15px'>
    <img src="<?= Url::to('@web/img/plugn-logo.png') ?>" alt="" style='width:180px; margin-bottom:10px;'>
...
<pre style='text-align:center; margin-top:5px;'>Note: Your agency account is different from the agent account created through the apps.<br/><a href='https://plugn.io/features/account-types/' target='_blank'>More info on the different account types</a></pre>
