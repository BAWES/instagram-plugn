...
class m161218_145037_add_country extends Migration
{
    public function up()
    {
        // Create the table
        $this->createTable('country', [
            ...
            'country_iso_code_2' => $this->string()->notNull(),
            'country_iso_code_3' => $this->string()->notNull(),
            'country_zipstate_required' => $this->boolean()->defaultValue(0)->notNull(),
            'country_addrline2_required' => $this->boolean()->defaultValue(0)->notNull(),
        ]);

        // Insert the values
        Yii::$app->db->createCommand()->batchInsert('country',
        ['country_id', 'country_name', 'country_iso_code_2', 'country_iso_code_3', 'country_zipstate_required', 'country_addrline2_required'],
        [
            ...
            [74, 'France, Metropolitan', 'FR', 'FRA', 0, 0],
